...
from Ferrit_toroid_core_library import ToroidCoreLibrary
...
class TestToroidVisualizer(unittest.TestCase):
    def setUp(self) -> None:
        self.core = ToroidCoreLibrary().get_core("2206")
    ...
    def test_render_smoke_2d(self) -> None:
        expected_path = self.expected_dir / f"test_toroid_visualizer_render_{self.timestamp}.png"
    ...
    def test_render_smoke_3d(self) -> None:
        expected_path = self.expected_dir / f"test_toroid_visualizer_render_{self.timestamp}_3d.png"
    ...
    def test_render_pdf_bundle(self) -> None:
        expected_2d = self.expected_dir / f"test_toroid_visualizer_render_{self.timestamp}.pdf"
        expected_3d = self.expected_dir / f"test_toroid_visualizer_render_{self.timestamp}_3d.pdf"
    ...
    def test_render_html_3d(self) -> None:
        expected_path = self.expected_dir / f"test_toroid_visualizer_render_{self.timestamp}_3d.html"
